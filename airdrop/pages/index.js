    ...
    try {
      ...
      setClaimMessage({
        ...
        payload: `
          ...
          -> Basic allocation: ${Web3.utils.fromWei(
            response.data.basicAllocation.toString()
          )} ETB
          -> Bonus allocation: ${Web3.utils.fromWei(
...
Reason" Airdrop already sent to ${address}`,
  ...
  return (
    <div className="container">
      ...
      {loading ? (
        <div className="row">
          <div className="col-sm-12">{loadingMessage}</div>
        </div>
      ) : null}
        ...
        <div className="row">
            ...
            <div className="card">
              <div className="card-body">
                ...
                <div className="card-text">
                  <ul>
                    <li>
                      Step 1: Make sure you have configured the BSC network with
                      Metamask
                    </li>
                    <li>
                      Step 2: Make sure you have some BNB to pay for transaction
                      fees (~1-2 USD worth of BNB, paid to the network
                    </li>
                    <li>
                      Step 3: Enter your BSC address and click on submit. This
                      will fetch an authorization signature from the list of
                      whitelisted address
                    </li>
                    <li>
                      Step 4: Confirm the transaction to claim your ETB tokens.
          ...
          <div className="col-sm-6">
            <form className="form-inline" onSubmit={(e) => claimTokens(e)}>
              ...
              />
              <button type="submit" className="btn btn-primary mb-2 col-sm-12">
                Submit
              </button>
            </form>
            <div>
